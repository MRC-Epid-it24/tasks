...
export default {
  ...
  fields: [
    { id: 'survey_id', name: 'Survey ID', type: sql.VarChar(500), opt: { nullable: false } },
    { id: 'user_id', name: 'User ID', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'start_time', name: 'Start time', type: sql.VarChar(500), opt: { nullable: true } },
    {
      id: 'submission_time',
    ...
    { id: 'food_amount', name: 'Food amount', type: sql.VarChar(500), opt: { nullable: true } },
    {
    ...
    { id: 'meal_id', name: 'Meal ID', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'meal_name', name: 'Meal name', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'food_source', name: 'Food source', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'food_id', name: 'Food ID', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'search_term', name: 'Search term', type: sql.VarChar(500), opt: { nullable: true } },
    {
    ...
    { id: 'satd_fa', name: 'Satd FA', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'protein', name: 'Protein', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'carbohydrate', name: 'Carbohydrate', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'total_sugars', name: 'Total sugars', type: sql.VarChar(500), opt: { nullable: true } },
    {
    ...
    { id: 'iron', name: 'Iron', type: sql.VarChar(500), opt: { nullable: true } },
    {
      id: 'alpha_carotene',
      name: 'Alpha-carotene',
      type: sql.VarChar(500),
    ...
    { id: 'cholesterol', name: 'Cholesterol', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'cis_mon_fa', name: 'Cis-Mon FA', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'cis_n_3_fa', name: 'Cis-n3 FA', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'cis_n_6_fa', name: 'Cis-n6 FA', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'copper', name: 'Copper', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'energy_k_j', name: 'Energy (kJ)', type: sql.VarChar(500), opt: { nullable: true } },
    {
      id: 'englyst_fibre',
      name: 'Englyst fibre',
      type: sql.VarChar(500),
    ...
    { id: 'glucose', name: 'Glucose', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'haem_iron', name: 'Haem iron', type: sql.VarChar(500), opt: { nullable: true } },
    {
    ...
    { id: 'magnesium', name: 'Magnesium', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'maltose', name: 'Maltose', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'manganese', name: 'Manganese', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'niacin', name: 'Niacin', type: sql.VarChar(500), opt: { nullable: true } },
    {
    ...
    { id: 'retinol', name: 'Retinol', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'riboflavin', name: 'Riboflavin', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'selenium', name: 'Selenium', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'sodium', name: 'Sodium', type: sql.VarChar(500), opt: { nullable: true } },
    {
      id: 'southgate_fibre',
    ...
    { id: 'thiamin', name: 'Thiamin', type: sql.VarChar(500), opt: { nullable: true } },
    {
      id: 'total_carotene',
      name: 'Total carotene',
      type: sql.VarChar(500),
    ...
    { id: 'vitamin_b_6', name: 'Vitamin B6', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'vitamin_d', name: 'Vitamin D', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'vitamin_e', name: 'Vitamin E', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'water', name: 'Water', type: sql.VarChar(500), opt: { nullable: true } },
    { id: 'zinc', name: 'Zinc', type: sql.VarChar(500), opt: { nullable: true } },
    {
      id: 'co₂_emissions',
      name: 'CO₂ emissions',
      type: sql.VarChar(500),
